...
public class Main {
    static void main() {
        ...
        BankService bankService = new BankServiceImpl(); // ye interface h aur isme assign horaha h implementation
        ...
        while(running) {
            ...
            switch(choice){
                ...
                case "5" -> bankstatement(scanner , bankService);
    ...
    private static void deposit(Scanner scanner, BankService bankService) {
        ...
        Double ammount = Double.valueOf(scanner.nextLine().trim());
        bankService.deposit( accountNumber, ammount, "Deposit");
    ...
    private static void withdraw(Scanner scanner, BankService bankService) {
        ...
        System.out.println("Amount: ");
        Double ammount = Double.valueOf(scanner.nextLine().trim());
        bankService.withdraw( accountNumber, ammount, "Withdrawl");
    ...
    private static void transfer(Scanner scanner, BankService bankService) {
        ...
        System.out.println("Amount: ");
        Double ammount = Double.valueOf(scanner.nextLine().trim());
        bankService.transfer( from , to, ammount, "Transfer");
    }

    private static void bankstatement(Scanner scanner, BankService bankService) {
        System.out.println("Account number");
    ...
    private static void searchAccount(Scanner scanner, BankService bankService) {
        System.out.println("Customer nsme contains: ");
